...
class Conv2dLN(nn.Module):
    def __init__(self, in_ch: int, out_ch: int, k: int = 3, bias: bool = True, layernorm: bool = False):
        super().__init__()
        pad = k // 2
...
class ConvLSTMCell(nn.Module):
    ...
    Standard ConvLSTM cell with 4 gates (i, f, o, g):
      ...
      h_t = o_t ⊙ tanh(c_t)
    """
    def __init__(self, in_ch: int, hid_ch: int, k: int = 3, bias: bool = True, layernorm: bool = False, peephole: bool = True):
        super().__init__()
        self.in_ch = in_ch
        self.hid_ch = hid_ch
...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, in_ch: int, hid_ch: int, k: int = 3, bias: int = True, layernorm: int = False, peephole: int = True):
        super().__init__()
